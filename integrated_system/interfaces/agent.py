"""
Agent interfaces for the integrated system.

This module defines the interfaces for agent components in the integrated system.
"""
...
class Agent(Component, Connectable, Configurable, Executable, Observable):
    """Interface for agent components in the integrated system."""
...
class Tool(Component, Configurable, Executable):
    """Interface for tool components in the integrated system."""
...
class Memory(Component, Configurable, Observable):
    """Interface for memory components in the integrated system."""
