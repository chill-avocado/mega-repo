# Merged file for browser_automation/rendering
...
from browser_use.browser.types import ClientCertificate
from browser_use.browser.types import Geolocation
from browser_use.browser.types import HttpCredentials
