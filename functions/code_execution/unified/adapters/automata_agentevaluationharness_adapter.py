# Adapter for automata/AgentEvaluationHarness
from functions.code_execution.automata.automata.eval.agent.agent_eval_harness import AgentEvaluationHarness
from ..codeexecutor import CodeExecutor

class AutomataAgentEvaluationHarnessAdapter(CodeExecutor):
    """Adapter for automata/AgentEvaluationHarness."""
    
    def __init__(self, config=None):
        """Initialize the adapter."""
        super().__init__(config)
        self.implementation = AgentEvaluationHarness(**config) if config else AgentEvaluationHarness()
